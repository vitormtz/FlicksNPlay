...
public class JogoModel {
    ...
    public JogoModel(int id, String genero1, String nome, String descricao, int classificacao_indicativa, boolean disponivel, double vl_locacao, char tipo) {
        this.id = id;
    ...
    public JogoModel(int id, int genero2, String nome, String descricao, int classificacao_indicativa, boolean disponivel, double vl_locacao, char tipo) {
        this.id = id;
    ...
    public JogoModel(int genero2, String nome, String descricao, int classificacao_indicativa, boolean disponivel, double vl_locacao, char tipo) {
        this.genero2 = genero2;
        this.nome = nome;
        this.descricao = descricao;
        this.classificacao_indicativa = classificacao_indicativa;
